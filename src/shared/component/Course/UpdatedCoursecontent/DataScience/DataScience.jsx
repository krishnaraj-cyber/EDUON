  ...
  return (
    <>
      ...
      <div className="dsov4p-flex">
        ...
        <div className="dsov4p-items">
            <h3>Complete in 4 to 8 years</h3>
            <p>299 credits. 18-20 hours of student effort per week.</p>
        </div>
        <div className="dsov4p-items">
            <h3>100% online</h3>
    ...
    <h2>Upskill for the changing tech landscape and prepare for emerging jobs in Data Science.
    </h2>
      ...
      <p>With flexible exit options at the end of each year, shape your education in a way that aligns with your career aspirations. You can exit with a Foundational Certificate in Data Science & AI at the end of the first year, a Diploma in Data Science & AI at the end of the second year, receive your Bachelor of Science degree upon completing all the courses in the third year, or earn an honours degree at the end of the fourth year.</p>
      ...
      <article className="dsov-certifi">
        ...
        <div >
            ...
            <p>Upon successful completion of the 4 year Bachelor of Science (Honours) in Data Science , you will receive a Bachelor's degree issued by Eduon.</p>
        </div>
        </div>
      </article>
    </>
