      ...
      <div className="frame9">
        <div className="frame09">
          <div className="disclaimercontent">
            <h2>Find Us</h2>
            <div>
              <img src="images/icons8-location-20.png" />
              <p>
                6890 Blvd, The Bronx, NY 1058
                <br />
                New York, USA
              </p>
            </div>
            <div>
              <img src="images/icons8-mail-20.png" />
              <p>
                hello@eduon.com
                <br />
                public@eduon.com
            ...
            <div>
              <img src="images/icons8-contact-20.png" />
              <p>
                +(514) 312-5678
                <br />
                +1(514) 312-6688
          ...
          <div className="disclaimercontent1">
            <h2>Useful Links</h2>
            <p>All Courses</p>
            <p>About us</p>
            <p>Help (FAQ)</p>
        ...
        <div className="dividerframe9"></div>

        <div className="copyrights">
          <img src="images/icons8-copyrights-24.png" />
          <p>
            {" "}
            Eduon is Proudly Owned by <span>HiBootstrap</span>
          </p>
        </div>
